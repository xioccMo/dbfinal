...
class TestTrackOrderByOrderId:
    ...
    def test_status_unpaid_ok(self):
        code = track_order_by_order_id(self.buyer_id, self.buyer_password, self.order_id)
        assert code == 200
    ...
    def test_error_user_id(self):
        code = track_order_by_order_id(self.buyer_id + "_x", self.buyer_password, self.order_id)
        assert code != 200
