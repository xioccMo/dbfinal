...
class TestTrackOrderByOrderId:
    ...
    def test_error_no_exist_origin_comment(self):
        self.total_price = 0
        for item in self.buy_book_info_list:
            book: Book = item[0]
            num = item[1]
    ...
    def test_error_user_id(self):
        ...
        self.content = "蔡徐坤爱乔碧萝"
        code = update_comment(self.buyer_id + "_x", self.buyer_password, self.orderdetail_id, self.content)
        assert code != 200
    ...
    def test_error_password(self):
        ...
        self.content = "蔡徐坤爱乔碧萝"
        code = update_comment(self.buyer_id, self.buyer_password + "_x", self.orderdetail_id, self.content)
        assert code != 200

    def test_error_content_null(self):
        self.total_price = 0
        for item in self.buy_book_info_list:
            book: Book = item[0]
            num = item[1]
